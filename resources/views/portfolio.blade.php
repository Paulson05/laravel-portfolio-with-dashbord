...
<head>
  ...
  <link href="assets3/vendor/font-awesome/css/font-awesome.min.css" rel="stylesheet">
  <link href="assets3/vendor/ionicons/css/ionicons.min.css" rel="stylesheet">
  <link href="assets3/vendor/owl.carousel/assets/owl.carousel.min.css" rel="stylesheet">
  ...
  <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-end" id="navbarDefault">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link js-scroll active" href="portfolio.blade.php">Home</a>
          </li>
          <li class="nav-item">
...
{{--          </li>--}}
  ...
  <!-- ======= Intro Section ======= -->
  <div id="" class="intro route bg-image" style="background-image: url(assets/img/intro-bg.jpg)">
